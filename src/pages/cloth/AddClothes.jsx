...
{...field} -> inputFields 에서 key 순서에 해당하는 id, label, placeholder 값을 FormInput으로 전달

onChange 이벤트 핸들러를 사용하지 않아도 되는가?
FormInput 내부에 onChange 를 추가해서 상태관리를 해야함

onChage가 없으면 사용자가 입력한 값을 저장할 수 없음
            하는 역할 : 사용자가 입력한 값을 임시저장 -> 저장해 놓은 값을 벡엔드로 전달
*/
const AddClothes = () => {
    // 의류 정보 상태 관리
    ...
    const inputFields = [
        {id:"cname", type:"text", label:"의류 명칭", placeholder:"의류 명칭을 입력하세요"},                                //index 0번
        {id:"ccategory", type:"text", label:"카테고리", placeholder:"카테고리(예: 티셔츠, 바지, 자켓)를 입력하세요"},
        {id:"cbrand", type:"text", label:"브랜드", placeholder:"브랜드를 입력하세요"},
        {id:"ccolor", type:"text", label:"색상", placeholder:"색상을 입력하세요"},
        {id:"csize", type:"text", label:"사이즈", placeholder:"사이즈(예: S, M, L, XL)를 입력하세요"},
        {id:"cmaterial", type:"text", label:"소재", placeholder:"소재를 입력하세요"},
        {id:"cprice", type:"number", label:"가격", placeholder:"가격을 입력하세요"},
        {id:"cstock", type:"number", label:"재고 수량", placeholder:"재고 수량을 입력하세요"},
        {id:"cgender", type:"text", label:"성별", placeholder:"성별(예: 공용, 남성, 여성)을 입력하세요"},
        {id:"cseason", type:"text", label:"시즌", placeholder:"시즌(예: 봄, 여름, 가을, 겨울 사계절)을 입력하세요"}        //index 9번
    ]
    ...
    */
    ...
    const handleSubmit = (e) => {
        e.preventDefault();// form 제출 태그가 제출되기 전에 체크하고 제출하기 위해 제출 지연
        ...
        axios
            ...
            .catch(
                (err) => {
                    alert("제품 등록에 실패했습니다. 백엔드를 학인하세요");
