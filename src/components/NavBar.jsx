                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                <li><Link className="nav-link" to="/posts">게시글목록</Link></li>
                                <li><Link className="nav-link" to="/posts/search">게시글 검색</Link></li>


                                <li>
                                    <hr className="dropdown-divider"/>
                                </li>
                                <li><Link className="nav-link" to="/posts/create">게시글 작성</Link></li>
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                <li><Link className="nav-link" to="/products">제품 목록</Link></li>
                                <li>
                                    <hr className="dropdown-divider"/>
                                </li>
                                <li><Link className="nav-link" to="/products/search">제품 검색</Link></li>
                            </ul>
                        </li>
